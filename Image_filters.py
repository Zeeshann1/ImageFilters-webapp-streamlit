...
if source_index == 0:
        if uploaded_file is not None:
                 ...
                 st.caption("<p style='color:red;font-weight:bold'>CONTOUR FILTER</p>", unsafe_allow_html=True)
...
if source_index == 1:
        if uploaded_file is not None:
                 st.caption("<p style='color:red;font-weight:bold'>ORIGINAL IMAGE</p>", unsafe_allow_html=True)
                 st.image(uploaded_file)
                 st.caption("<p style='color:red;font-weight:bold'>SMOOTH MORE FILTER</p>", unsafe_allow_html=True)
...
if source_index == 2:
        if uploaded_file is not None:
                 st.caption("<p style='color:red;font-weight:bold'>ORIGINAL IMAGE</p>", unsafe_allow_html=True)
                 st.image(uploaded_file)
                 st.caption("<p style='color:red;font-weight:bold'> SHARPEN FILTER</p>", unsafe_allow_html=True)
...
if source_index == 3:
        if uploaded_file is not None:
                 st.caption("<p style='color:red;font-weight:bold'>ORIGINAL IMAGE</p>", unsafe_allow_html=True)
                 st.image(uploaded_file)
                 st.caption("<p style='color:red;font-weight:bold'>EDGE ENHANCE MORE FILTER</p>", unsafe_allow_html=True)
...
if source_index == 4:
        if uploaded_file is not None:
                 st.caption("<p style='color:red;font-weight:bold'>ORIGINAL IMAGE</p>", unsafe_allow_html=True)
                 st.image(uploaded_file)
                 st.caption("<p style='color:red;font-weight:bold'>DETAIL FILTER</p>", unsafe_allow_html=True)
...
if source_index == 5:
        if uploaded_file is not None:
                 st.caption("<p style='color:red;font-weight:bold'>ORIGINAL IMAGE</p>", unsafe_allow_html=True)
                 st.image(uploaded_file)
                 st.caption("<p style='color:red;font-weight:bold'>EMBOSS FILTER</p>", unsafe_allow_html=True)
...
if source_index == 6:
        if uploaded_file is not None:
                 st.caption("<p style='color:red;font-weight:bold'>ORIGINAL IMAGE</p>", unsafe_allow_html=True)
                 st.image(uploaded_file)
                 st.caption("<p style='color:red;font-weight:bold'>BLUR FILTER</p>", unsafe_allow_html=True)
...
if source_index == 7:
    if uploaded_file is not None:
        ...
        col2.caption("<p style='color:red;font-weight:bold'>SMOOTH MORE FILTER</p>", unsafe_allow_html=True)
        img2 = picture.filter(ImageFilter.SMOOTH_MORE)
        col2.image(img2)
        col2.download_button("Download Result", convert_image(img2), "Result.png", "image/png")

        col3.caption("<p style='color:red;font-weight:bold'>SHARPEN FILTER</p>", unsafe_allow_html=True)
        img3 = picture.filter(ImageFilter.SHARPEN)
        col3.image(img3)
        ...
        col2.caption("<p style='color:red;font-weight:bold'>DETAIL FILTER</p>", unsafe_allow_html=True)
        img5 = picture.filter(ImageFilter.DETAIL)
        col2.image(img5)
        col2.download_button("Download Result", convert_image(img5), "Result.png", "image/png")

        col3.caption("<p style='color:red;font-weight:bold'>EMBOSS FILTER</p>", unsafe_allow_html=True)
        img6 = picture.filter(ImageFilter.EMBOSS)
        col3.image(img6)
        col3.download_button("Download Result", convert_image(img6), "Result.png", "image/png")

        col2.caption("<p style='color:red;font-weight:bold'>BLUR FILTER</p>", unsafe_allow_html=True)
        img7 = picture.filter(ImageFilter.GaussianBlur(radius=2))
        col2.image(img7)
